...
<article class="<?php echo esc_attr( $classes ); ?>">
	<a class="blog-card__link" href="<?php echo esc_url( $link ); ?>">
		<div class="blog-card__image<?php echo $has_thumb ? '' : ' blog-card__image--placeholder'; ?>">
			<?php if ( $has_thumb ) : ?>
				<?php echo get_the_post_thumbnail( $post_id, 'medium_large' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
			<?php else : ?>
				<?php echo tolstenko_get_card_placeholder_image_html( 'medium_large', $title ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
			<?php endif; ?>
