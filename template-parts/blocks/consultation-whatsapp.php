...
if ( $blog_inline && function_exists( 'tolstenko_get_article_consultation_defaults' ) ) {
	$defaults = tolstenko_get_article_consultation_defaults( 'article_consultation_whatsapp', 'consultation_whatsapp' );
} else {
...
if ( $blog_inline ) :
	?>
	<div class="article-cta article-cta--whatsapp" style="--article-cta-accent: <?php echo esc_attr( $color ); ?>;">
		<?php if ( $title !== '' || $text !== '' ) : ?>
			<div class="article-cta__content">
				...
				<?php endif; ?>
				<?php if ( $text !== '' ) : ?>
					<p class="article-cta__text"><?php echo tolstenko_kses_html( $text ); ?></p>
				<?php endif; ?>
			</div>
		<?php endif; ?>
