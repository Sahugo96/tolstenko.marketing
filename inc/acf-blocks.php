    ...
    if ( function_exists( 'tolstenko_get_block_defaults' ) ) {
        ...
        wp_localize_script(
            ...
            array(
                ...
                'article_consultation_whatsapp' => function_exists( 'tolstenko_get_article_consultation_defaults' ) ? tolstenko_get_article_consultation_defaults( 'article_consultation_whatsapp', 'consultation_whatsapp' ) : array(),
                'article_consultation_tg'       => function_exists( 'tolstenko_get_article_consultation_defaults' ) ? tolstenko_get_article_consultation_defaults( 'article_consultation_tg', 'consultation_tg' ) : array(),
                'isContentBody' => ( static function () {
                    $pt = '';
                    if ( ! empty( $_GET['post'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                        $pt = (string) get_post_type( (int) $_GET['post'] );
                    ...
                    return $pt !== '' && function_exists( 'tolstenko_is_content_body_post_type' ) && tolstenko_is_content_body_post_type( $pt );
                } )(),
                ...
                'not_the_end'           => tolstenko_get_block_defaults( 'not_the_end' ),
...
function tolstenko_get_theme_block_attributes() {
    return array(
        ...
        'consultation-tg' => array(
            ...
            'block_consultation_tg_color'       => array( 'type' => 'string', 'default' => '' ),
            'block_consultation_tg_color_hover' => array( 'type' => 'string', 'default' => '' ),
        ...
        'result' => array(
            ...
            'block_result_text'      => array( 'type' => 'string', 'default' => '' ),
        ),
        'promotion' => array(
            'block_promotion_subtitle'   => array( 'type' => 'string', 'default' => '' ),
            'block_promotion_title'      => array( 'type' => 'string', 'default' => '' ),
            'block_promotion_title_tag'  => array( 'type' => 'string', 'default' => 'h2' ),
            'block_promotion_text'       => array( 'type' => 'string', 'default' => '' ),
            'block_promotion_items'      => array( 'type' => 'array', 'default' => array() ),
            'block_promotion_micro_title'=> array( 'type' => 'string', 'default' => '' ),
            'block_promotion_list'       => array( 'type' => 'array', 'default' => array() ),
        ),
        'pricing' => array(
            'block_pricing_subtitle'     => array( 'type' => 'string', 'default' => '' ),
            'block_pricing_title'        => array( 'type' => 'string', 'default' => '' ),
            'block_pricing_title_tag'    => array( 'type' => 'string', 'default' => 'h2' ),
            'block_pricing_text'         => array( 'type' => 'string', 'default' => '' ),
            'block_pricing_items'        => array( 'type' => 'array', 'default' => array() ),
        ),
        'not-the-end' => array(
            'block_not_the_end_title'    => array( 'type' => 'string', 'default' => '' ),
            'block_not_the_end_text'     => array( 'type' => 'string', 'default' => '' ),
            'block_not_the_end_icon'     => array( 'type' => 'integer', 'default' => 0 ),
            'block_not_the_end_avatars'  => array( 'type' => 'array', 'default' => array() ),
            'block_not_the_end_btn_text' => array( 'type' => 'string', 'default' => '' ),
        ...
        'blog-pros-cons' => array(
            'block_blog_pros_cons_pros_title' => array( 'type' => 'string', 'default' => '' ),
            'block_blog_pros_cons_cons_title' => array( 'type' => 'string', 'default' => '' ),
            'block_blog_pros_cons_pros'       => array(
                'type'    => 'array',
                'default' => array(),
            ),
            'block_blog_pros_cons_cons'       => array(
                'type'    => 'array',
                'default' => array(),
            ),
        ),
...
function tolstenko_register_theme_blocks() {
    ...
    $blocks = array(
        ...
        array( 'name' => 'not-the-end', 'title' => __( 'Ещё не конец', 'tolstenko-theme' ), 'category' => $cat_new ),
